    ...
    <div id="login">
        <form novalidate class="md-layout" @submit.prevent="login">
            <md-card class="md-layout-item md-size-50 md-small-size-50">
                    ...
                    <div class="md-layout md-gutter">
                        <div class="md-layout-item md-small-size-80">
                            <md-field class="username">
                                ...
                                <md-input v-model="username" name="login-user-name" id="login-user-name" />
                        ...
                        <div class="md-layout-item md-small-size-30">
                            <md-field class="password">
                                ...
                                <md-input v-model="password" name="login-password" id="login-password" type="password" />
                ...
                <md-card-actions>
                    <md-button class="md-primary"  @click="createAccount()">Sign up</md-button>
